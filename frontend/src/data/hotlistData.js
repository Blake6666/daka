...
export const HOTLISTS = [
  {
    ...
    items: [
      { rank: 1, title: '秋季开学第一周 神兽归笼', heat: '482万', source: '微博', url: 'https://weibo.com/hot/search', tag: '沸' },
      ...
      { rank: 4, title: '秋天的第一杯奶茶又来了', heat: '312万', source: '微博', url: 'https://weibo.com/hot/search', tag: '新' },
  ...
  },
  {
    ...
    updated_at: '2026-09-21 08:00',
    items: [
      { rank: 1, title: '台风路径最新消息', heat: '98万', source: '百度', url: 'https://top.baidu.com/board?tab=realtime', tag: '热' },
      ...
      { rank: 7, title: '考研预报名开始', heat: '47万', source: '百度', url: 'https://top.baidu.com/board?tab=realtime', tag: '新' },
  ...
  },
  {
    ...
    updated_at: '2026-09-21 08:00',
    items: [
      { rank: 1, title: '沉浸式收纳宿舍桌面', heat: '1021万', source: '抖音', url: 'https://www.douyin.com/hot', tag: '沸' },
      ...
      { rank: 9, title: '宠物迷惑行为大赏', heat: '376万', source: '抖音', url: 'https://www.douyin.com/hot', tag: '新' },
